...
export class HomeComponent {
  items = [
    ...
    { name: 'Vue', description: `Get started with Vue.js routing by exploring our example app! This interactive demo showcases a simple todo list application that utilizes Vue Router to manage client-side routing. Browse through the app's features, including dynamic routing, parameter passing, and navigation between components. Learn how Vue Router enables seamless navigation and enhances your application's overall user experience.`, url: 'https://djvelimir.github.io/demo-spa-vue/' },
