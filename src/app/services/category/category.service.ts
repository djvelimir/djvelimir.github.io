    ...
    return of([
      {
        ...
        items: [
          ...
          {
            name: 'Vue',
            url: 'https://github.com/djvelimir/demo-spa-vue',
          },
          {
            name: 'React',
            url: 'https://github.com/djvelimir/demo-spa-react',
          },
          {
            name: 'Vite + React',
          ...
          {
            name: 'Hugo',
            url: 'https://github.com/djvelimir/blog',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: 'iOS',
            url: 'https://github.com/djvelimir/demo-mobile-ios',
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            name: 'C',
            url: 'https://github.com/djvelimir/demo-c',
          },
          {
            name: 'C++',
            url: 'https://github.com/djvelimir/demo-cpp-cli',
          },
          {
            name: 'Rust',
            url: 'https://github.com/djvelimir/demo-rust',
          },
          {
            name: 'Go (Golang)',
            url: 'https://github.com/djvelimir/demo-go',
          },
          {
            name: 'Python',
          ...
          {
            name: 'Node.js',
            url: 'https://github.com/djvelimir/demo-node',
          },
          {
            name: 'Ruby',
            url: 'https://github.com/djvelimir/demo-ruby-quine',
          },
          {
            name: 'PHP',
            url: 'https://github.com/djvelimir/demo-php',
          },
        ],
      },
    ]);
